    ...
    this.registerLoginName.blur(function(){
        ...
        }else
		{
            ...
            if(regex.test(loginName))
			{
				...
				$.ajax("./validateConflictLoginName", {
                type: "POST",
				dataType: "json",
				data: params || {},
				success: function (resultInfo) {
					if (resultInfo.result != "success") {
						var errorInfo = errorInfo = resultInfo.message;
...
//        FindPwd.inputIconDisplay(_this.findpwdImgAuthCodeIconTip,0);
	...
	this.registerUserPwd.keyup(function(){
	    var userPwd = _this.registerUserPwd.val();
