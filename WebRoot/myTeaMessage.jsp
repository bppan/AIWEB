...
<head>
    ...
    <script type="text/javascript" src="js/myTeaMessage.js" charset="GB2312"></script>
</head>
 		...
 		<div id = "content_Contentwarp" class = "tk_content_Contentwarp">
 				<div id = "contentWrap" class = "kcontentControl faw ">
	 				<div  class = "control faw">
		 				<div>
			 				<input type='text'  id="studentId"  placeholder="教师id"  class='searchText faw' /> 	
			 				<input type='text'  id="studentName" placeholder="教师姓名"  class='searchText faw' /> 	
			 				<span  id="searchBut" name="searchBut" class = "button faw">搜索</span>	
			
						</div>
						<div  class = "faw" style = "margin-top:10px;">
		 					<span id = "searchTip" style = "color:red;margin-top:100px;"> 请在输入教师id或教师登录名后（不输入默认为全搜索），点击搜索按钮或回车，进行搜索。</span>	
		 				</div>		
		 			</div>
