...
<head>
    ...
    <script type="text/javascript" src="js/browseTeacher.js" charset="GB2312"></script>
 				...
 				<div id = "contentWrap" class = "kcontentControl faw ">
					<table width="900" border="1" style = "margin:5px auto">
					  ...
					  <tr class = "trMessage">
						...
						<td width="230">
						  <input type="text" name="teName" id="teaName"  readonly="readonly" class = "text2 faw" />
						</td>
						<td width="99" class = "tc">性别</td>
						<td width="236" class = "pdl5"><p>
						  <label>
							<input type="radio" name="teaSex" value="1" id="teaSex_0"  readonly="readonly"/>
							男</label>
						  <label style = "margin-left:20px">
							<input type="radio" name="teaSex" value="0" id="teaSex_1" readonly="readonly" />
							女</label>
						</p></td>
					  </tr>
					  <tr class = "trMessage">
						<td class = "tc">出生年月</td>
						<td ><input type="text" name="birthDate" id="birthDate" readonly="readonly" class = "text2 faw"/></td>
						<td class = "tc">最终学位</td>
						<td><input type="text" name="tea_degree" id="tea_degree" readonly="readonly" class = "text2 faw"/></td>
					  </tr>
					  <tr class = "trMessage ">
						<td class = "tc">毕业院校</td>
						<td>
						  <input type="text" name="user_graduate_School" id="user_graduate_School" readonly="readonly" class = "text2 faw"/>
						</td>
						<td class = "tc">从事专业</td>
						<td><input type="text" name="user_major" id="user_major" readonly="readonly" class = "text2 faw"/></td>
					  </tr>
					  <tr class = "trMessage ">
						<td class = "tc">所属院系</td>
						<td>
						  <input type="text" name="user_collage" id="user_collage"  readonly="readonly" class = "text2 faw"/>
						</td>
						<td  class = "tc">职务</td>
						<td>
						  <input type="text" name="user_job" id="user_job" readonly="readonly" class = "text2 faw"/>
						</td>
					  </tr>
					  <tr class = "trMessage ">
						<td class = "tc">所属研究所</td>
						<td >
						  <input type="text" name="user_laboratory" id="user_laboratory"  readonly="readonly" class = "text2 faw"/>
						</td>
						<td  class = "tc">职称</td>
						<td>
						  <input type="text" name="user_job_title" id="user_job_title"  readonly="readonly" class = "text2 faw"/>
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr class = "trMessage ">
						<td class = "tc">办公电话</td>
						<td><label>
						  <input type="text" name="user_office_phone" id="user_office_phone" readonly="readonly"  class = "text2 faw" />
						</label></td>
						<td class = "tc">Email</td>
						<td><label>
						  <input type="text" name="user_email" id="user_email" readonly="readonly"  class = "text2 faw"/>
						</label></td>
					  </tr>
					  <tr class = "trMessage ">
						<td class = "tc">通讯地址</td>
						<td colspan="3"><label>
						  <input type="text" name="user_address" id="user_address" readonly="readonly" class = "text3 faw"/>
						</label></td>
					  </tr>
					  <tr  class = "trMessage ">
						<td class = "tc">邮编</td>
						<td colspan="3"><label>
						  <input type="text" name="user_post" id="user_post" readonly="readonly" class = "text3 faw"/>
						</label></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="4"><label>
						  <textarea name="user_resume"  cols="126" rows="10" id="user_resume" readonly="readonly" class = "faw ft14"></textarea>
						</label></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="4">
						  <textarea name="user_research_direction" id="user_research_direction"  readonly="readonly" cols="126" rows="15" class = "faw ft14"></textarea>
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="4"><label>
						  <textarea name="user_teach_work" id="user_teach_work" readonly="readonly" cols="126" rows="10" class = "faw ft14"></textarea>
						</label></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="4"><label>
						  <textarea name="user_awards" id="user_awards" readonly="readonly" cols="126" rows="12" class = "faw ft14"></textarea>
						</label></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="4"><label>
						  <textarea name="user_book" id="user_book" cols="126" readonly="readonly" rows="20" class = "faw ft14"></textarea>
						</label></td>
					  </tr>
					</table>
